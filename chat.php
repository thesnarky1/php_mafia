        ...
        if(isset($_GET['id']) && isset($_GET['user_id']) && 
            ...
            if($phase) {
                ...
                $query = "SELECT channels.channel_id, channels.channel_name ".
                         ...
                         "WHERE users.user_hash='$user_hash' AND users.user_id=channel_members.user_id AND ".
                         "channel_members.user_id='$user_id' AND ".
                         "channel_members.channel_id=channels.channel_id AND channels.game_id='$game_id'";
                $result = mysqli_query($dbh, $query);
                if($result && mysqli_num_rows($result) >= 1) {
